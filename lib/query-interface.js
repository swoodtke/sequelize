...
module.exports = (function() {
  ...
  QueryInterface.prototype.startTransaction = function() {
    var sql = this.QueryGenerator.startTransactionQuery()
    return queryAndEmit.call(this, sql, 'startTransaction')
  }

  QueryInterface.prototype.commitTransaction = function() {
    var sql = this.QueryGenerator.commitTransactionQuery()
    return queryAndEmit.call(this, sql, 'commitTransaction')
  }

  QueryInterface.prototype.revertTransaction = function() {
    var sql = this.QueryGenerator.revertTransactionQuery()
    return queryAndEmit.call(this, sql, 'revertTransaction')
  }
